...
void drawCloud(float a, float b, float c, float d) {
...
void init() {
    ...
    basewall = loadTexture("../images/basewall.bmp");
    ...
    sndScratch = Mix_LoadWAV("../images/jumpSoundBetter.wav");
    if (sndScratch == NULL) {
        cout << "couldn't load scratch.wav: "<< Mix_GetError() << endl;
    }
...
//                    fill(NULL, x * tileWidth - tileOffsetX, y * tileHeight - tileOffsetY, (x+1)*tileWidth - tileOffsetX, (y+1)*tileHeight - tileOffsetY, 0.48235f, 0.47451f, 1.00000f);
            ...
            case '#':
                ...
                break;
            case '%':
                    fill(cloud, x * tileWidth - tileOffsetX, y * tileHeight - tileOffsetY, (x+1)*tileWidth - tileOffsetX, (y+1)*tileHeight - tileOffsetY, 0.8f, 0.0f, 0.0f);
                    break;
            case '$':
